...
export default function ProfileScreen({ persona, tweaks }: ProfileScreenProps) {
  ...
  return (
    <div className="fade-up screen-root w-full max-w-[1180px] mx-auto px-6 pt-6 pb-10 grid gap-5">
      {/* Identity card */}
      <div className="panel profile-identity p-6 grid gap-5 grid-cols-[auto_1fr] items-center">
        <div className="relative">
          <Avatar seed={7} size={88} />
          <div
            className="absolute -bottom-2 -right-2 px-2 py-1 rounded-[6px] text-[11px] font-bold font-mono"
            style={{
      ...
      <div className="profile-grid grid gap-5 grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
        ...
        <div className="panel p-5 flex flex-col gap-[18px]">
          ...
          <div>
            ...
            <div
              className="mt-3 flex items-end gap-[3px] h-[100px] p-[10px] rounded-[10px]"
